...
> **[AFBEELDING 1: TensorBoard — Cumulative Reward, run BankGuard_v7,
> 0-3 M steps, geen smoothing, legende aan, asbenamingen "Steps" en
> "Cumulative Reward".]**

> **[AFBEELDING 2: TensorBoard — Episode Length voor BankGuard_v7,
> 0-3 M steps.]**

> **[AFBEELDING 3: TensorBoard — Policy Loss en Value Loss voor
> BankGuard_v7, beide series getekend.]**

> **[AFBEELDING 4: TensorBoard — Entropy curve voor BankGuard_v7,
> 0-3 M steps.]**

> **[AFBEELDING 5: TensorBoard — Curiosity Reward voor BankGuard_v7,
> 0-3 M steps.]**

### Beschrijving van de grafieken

- **Cumulative Reward** — toont drie fases: een vlakke verkenningsfase
  (0-1,2 M, reward ≈ 5-15), een opbouwfase (1,2-2,3 M, reward ≈ 15-35)
  en een doorbraak (2,3 M, reward ≈ 35 → 85). Na de doorbraak schommelt
  de reward tussen 49 en 91.
- **Episode Length** — neemt af naarmate de bewaker leert sneller te
  vangen: van rond 3 000 stappen (max) naar gemiddeld 1 200-1 800 in de
  laatste 500 K steps.
- **Policy Loss** — daalt geleidelijk tot ≈ 0,015 en blijft daar stabiel.
- **Value Loss** — piekt rond 2,3 M (de doorbraak), vlakt vervolgens af.
- **Entropy** — daalt monotoon van ≈ 1,1 naar ≈ 0,55, conform een
  policy die steeds zekerder kiest.
- **Curiosity Reward** — toont een sterke daling tijdens de eerste
  500 K steps en stabiliseert daarna, wat aangeeft dat de agent zijn
  omgeving grotendeels heeft afgedekt.
